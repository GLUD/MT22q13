...
require_once(Config::PATH . Config::GENERAL . 'genericAjaxControls/comp/AjaxControlLst.php');
...
class AjaxControlLstView {
    ...
    private function CreateComponent() {
        $this->ajaxControlLst = new AjaxControlLst($this->ajaxControlConfigDataLst,$this->generalSearchVo);
    }
    ...
    private function PaintComponent() {
        $this->ajaxControlLst->Paint($this->nokTemplate);
    }
