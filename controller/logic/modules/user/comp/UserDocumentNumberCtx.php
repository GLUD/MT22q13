...
class UserDocumentNumberCtx {
    ...
    public function __construct($forma) {
        $this->ctx = new PCampoTexto("userDocumentNumberCtx");
    ...
    public function Paint($nokTemplate) {
        $this->ctx->modErrorMensaje("*Por favor ingrese el numero de documento");
        $this->ctx->adiPropiedad("class", "form-control");
        $this->ctx->adiPropiedad("maxlength", "50");
        $this->ctx->adiPropiedad("placeholder", "Numero documento");
